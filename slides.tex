...
\begin{block}{Optimization : list buffer}
\begin{itemize}
\item Compact set of key/value integers
\item Speed up insertions with an usorted list of values to insert
\item Sort list, remove duplicates
\item Merge the set and the list in linear time
\end{itemize}
\end{block}
